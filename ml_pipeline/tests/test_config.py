...
class TestTradingConfig:
    ...
    def test_to_array(self):
        ...
        np.testing.assert_almost_equal(arr[2], 4.0, decimal=5)  # max_positions
    ...
    def test_from_array(self):
        ...
        arr = np.array([2.0, 0.55, 3.0, -0.015, 0.12], dtype=np.float32)
    ...
    def test_sample_random(self):
        ...
        assert config.max_positions in [1, 2, 3, 4, 5]
    ...
    def test_sample_random_different(self):
        ...
        different = (
            ...
            config1.max_positions != config2.max_positions or
    ...
    def test_moderate_preset(self):
        """Test moderate configuration preset."""
    ...
    def test_validate_invalid_max_positions_low(self):
        """Test validation rejects max_positions < 1."""
        config = TradingConfig(max_positions=0)
        assert config.validate() is False

    def test_validate_invalid_max_positions_high(self):
        """Test validation rejects max_positions > 5."""
