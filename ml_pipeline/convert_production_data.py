    ...
    for snapshot in snapshots:
        ...
        for opp in snapshot['opportunities']:
            ...
            row = {
                ...
                'fund_profit_8h_24h_proj': opp.get('fundProfit8h24hProj', 0.0),
                'fund_apr_24h_proj': opp.get('fundApr24hProj', 0.0),
                'fundBreakEvenTime24hProj': opp.get('fundBreakEvenTime24hProj', 0.0),
                'fund_profit_8h_3d_proj': opp.get('fundProfit8h3dProj', 0.0),
                'fund_apr_3d_proj': opp.get('fundApr3dProj', 0.0),
                'fundBreakEvenTime3dProj': opp.get('fundBreakEvenTime3dProj', 0.0),
                'price_spread_24h_avg': opp.get('priceSpread24hAvg', 0.0),
                'price_spread_3d_avg': opp.get('priceSpread3dAvg', 0.0),
                'spread_30_sample_avg': opp.get('spread30SampleAvg', 0.0),
