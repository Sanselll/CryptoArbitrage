...
namespace CryptoArbitrage.API.Migrations
{
    ...
    [Migration("20251104180245_AddExecutionMetadataAndRequireExecutionId")]
    partial class AddExecutionMetadataAndRequireExecutionId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptoArbitrage.API.Data.Entities.Position", b =>
                {
                    ...
                    b.Property<DateTime?>("ReconciliationCompletedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("CryptoArbitrage.API.Data.Entities.PositionTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TransactionId", "Exchange");
            ...
            modelBuilder.Entity("CryptoArbitrage.API.Data.Entities.PositionTransaction", b =>
                {
                    b.HasOne("CryptoArbitrage.API.Data.Entities.Position", "Position")
